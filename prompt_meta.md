...
---
На основе актуального repository snapshot (в файле `krl_multimedia_dict_android_v25.md`) и моих наблюдений выше: тщательно проанализируй и детально сообщи, какие ошибки есть в коде и как их можно исправить?
...
Сформулируй CLI prompt (на основе твоего предыдущего ответа и repository snapshot в файле `<имя-файла>.md`) только для подзадачи <название выбранной подзадачи>.
...
CLI prompt для Qwen3-Coder-Next должен:
   ...
   - не упоминать repository snapshot и не советовать читать `<имя-файла>.md`;
